...
// Define Taurus-style connections by ID
const connections: [number, number][] = [
    [1, 2], [2, 3], [3, 4],     // left arc
    [3, 5],                    // small upper arc
    [1, 6], [6, 7],            // upper right horn
    [1, 8], [8, 9], [9, 10],   // lower right horn
  ];
  ...
  return (
    <div className="relative w-full h-[600px] bg-transparent">
      ...
      {milestones.map((m) => (
        <motion.div
          key={m.id}
          className="absolute bg-white rounded-full w-4 h-4 shadow-[0_0_8px_2px_rgba(255,192,203,0.4)] cursor-pointer"
